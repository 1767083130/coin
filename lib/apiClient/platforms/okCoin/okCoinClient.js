...
function OkCoinClient(options) {
    if (!(this instanceof OkCoinClient)) {
        return new OkCoinClient(options);
    }
    options = options || {};
    ...
    this.REST_URL = options.restUrl || configUtil.getRestUrl('okcoin');
 ...
 */
OkCoinClient.prototype.invoke = function (method, params, reponseNames, defaultResponse, type, callback) {
    params = params || [];
...
OkCoinClient.prototype._wrapJSON = function (s) {
 ...
 * @public
 */
OkCoinClient.prototype.request = function (params, type,apiName, callback) {
...
OkCoinClient.prototype.buildMethodUrl = function(serverUrl,methodName){
    if (!methodName){
        return serverUrl;
    }
 ...
 * @return 返回当前时间戳
 */
OkCoinClient.prototype.timestamp = function () {
 ...
 */
OkCoinClient.prototype.sign = function (params) {
    ...
    var token = util.md5(basestring).toUpperCase();
 ...
 * execute top api
 */
OkCoinClient.prototype.execute = function (apiname,params, callback) {
    this.invoke(apiname, params, [apiname], null, 'POST', callback);
};

exports.OkCoinClient = OkCoinClient;
