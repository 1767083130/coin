...
var StopLossLogModel = function () {
    const StopLossLogSchema = mongoose.Schema({
        ...
        tradeId: { type: Schema.ObjectId }, //止损下单的交易Id
        ...
        forceStopTradeId: {  type: Schema.ObjectId  },

        /* 止损后重新上涨，弥补止损错误 */
        reverseTradeId: { type: Schema.ObjectId }, //止损下单的交易Id

        /* 止损顺势做多失败后，强制执行 */
        forceReverseStart: { type: Date },
        forceReverseTradeId: {  type: Schema.ObjectId  },
